...
require_once $wpseo_premium_dir . 'classes/class-wpseo-premium.php';
/**
...
function auto_update_specific_zhaket_plugins_yoast ( $update, $item ) {
...
add_filter( 'auto_update_translation', 'auto_update_specific_zhaket_plugins_yoast', 10, 2 );