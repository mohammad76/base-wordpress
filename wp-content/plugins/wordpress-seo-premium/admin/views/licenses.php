	...
	<div id="extensions">
		<section class="yoast-seo-premium-extension">
			...
			<?php if ( $extension_list->is_installed( $extension->get_title() ) ) : ?>
				...
				<?php if ( 'digerati'=='digerati' ) : ?>
					<div class="yoast-button yoast-button--noarrow yoast-button--extension yoast-button--extension-activated"><?php esc_html_e( 'Activated', 'wordpress-seo' ); ?> به نام دیجیراتی </div>
