	...
	protected function register_yoast_plugins() {
		$this->plugins = array(
			'yoast-seo-premium' => array(
				'url'          => WPSEO_Shortlinker::get( 'https://zhaket.com/product/yoast-seo-premium-wordpress-plugin/' ),
			...
			'local-seo-for-yoast-seo' => array(
				'url'          => WPSEO_Shortlinker::get( 'https://zhaket.com/product/yoast-local-seo/' ),
				'title'        => 'Local SEO',
			...
			'yoast-woocommerce-seo' => array(
				'url'           => WPSEO_Shortlinker::get( 'https://zhaket.com/product/yoast-woocommerce-seo/' ),
